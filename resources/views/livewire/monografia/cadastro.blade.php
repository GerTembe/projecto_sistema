    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-12 col-xxl-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{Route('monografia.cadastro')}}" method="post" id="step-form-horizontal" class="step-form-horizontal">
                            @csrf()
                            <div>  
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 mb-4">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="submission_date" id= "name" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 mb-4">
                                            <div class="form-group">
                                                <label for="name1"class="text-label">Arquivo</label>
                                                <input type="file" name="file" id= "name1" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 mb-4">
                                            <div class="form-group">
                                                <label for="name1q"class="text-label">Título</label>
                                                <input type="text" name="title" id= "name1q" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 mb-4">
                                            <div class="form-group">
                                                <label for="nam"class="text-label">Nota</label>
                                                <input type="text" name="note" id= "nam" class="form-control" required>
                                            </div>
                                        </div>
